...
export declare type SignupuserOverridesProps = {
    Signupuser?: PrimitiveOverrideProps<ViewProps>;
...
export declare type SignupuserProps = React.PropsWithChildren<Partial<ViewProps> & {
    overrides?: SignupuserOverridesProps | undefined | null;
}>;
export default function Signupuser(props: SignupuserProps): React.ReactElement;
